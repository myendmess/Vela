<p align="center">
  <img src="assets/Vela_Icon.png" alt="Vela — Global Market Synergy" width="600">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/myendmess/Vela/actions/workflows/globe.yml"><img alt="Heatmap data" src="https://img.shields.io/github/actions/workflow/status/myendmess/Vela/globe.yml?label=heatmap%20data&logo=githubactions&logoColor=white"></a>
...
<p align="center">
  <a href="https://myendmess.github.io/Vela/globe/dashboard/"><img alt="Live dashboard" src="https://img.shields.io/badge/S%26P%20500%20heatmap-live-fbbf24?logo=googlechrome&logoColor=black"></a>
...
| [Heatmap Data](.github/workflows/globe.yml) | `0 23 * * *` | NASDAQ charts | [Live finviz-style S&P 500 treemap](https://myendmess.github.io/Vela/globe/dashboard/) |
...
├── globe/             # S&P 500 heatmap: data builder + static ECharts dashboard
